...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://adorable-narwhal-70a15e.netlify.app/`
            : `https://adorable-narwhal-70a15e.netlify.app/`, // Site domain. Do not include a trailing slash!
